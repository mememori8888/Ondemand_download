...
# col_number = cell.col
# print(col_number)
CL_column = sheet.col_values('90')[18:]
print(CL_column)
# IDinDashboard = list(filter(lambda x: x != '', by_column))
IDinDashboard = CL_column
...
for i in range(0,count,1):
    ...
    print('分岐点{}_{}'.format(user_name,i))
    if  user_name == 'nan' or 'エラー' in user_name or '/' in user_name or user_name == '-' or user_name == '':
        output_list = ['','','','','','','','']
        print(output_list)
